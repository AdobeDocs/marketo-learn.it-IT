...
>[!VIDEO](https://video.tv.adobe.com/v/3432364/?captions=ita&t=170/?quality=12&learn=on){transcript=true}
...
* [Panoramica su Identity Management di Adobe](https://experienceleague.adobe.com/it/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview){target="_blank"}
...
* [Come utilizzare Adobe Admin Console](https://helpx.adobe.com/it/enterprise/using/admin-console.html){target="_blank"}

### &#x200B;3. Annuncerà ai team interni la tempistica e la preparazione della migrazione necessarie {#announce-the-migration-timeline}
...
i. Hai ricevuto un&#39;e-mail di richiesta di verifica e-mail con un collegamento (la validità è di 3 giorni). Se il collegamento è scaduto, puoi inviare nuovamente l’e-mail di verifica dall’interno di Marketo Engage facendo clic sull’icona “Il mio profilo”, quindi passando a **Il mio account** > **Impostazioni account** > **Invia di nuovo la verifica**.
...
i. Accetta il nuovo invito facendo clic sul pulsante &quot;Accetta invito&quot; e accedendo con Adobe Identity.
