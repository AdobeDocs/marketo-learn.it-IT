...
user-guide-description: Raccolta di video e tutorial per Adobe Marketo Engage.
...
+ E-mail marketing {#email-marketing}
   ...
   + [[!UICONTROL Produzione di lead]](email-marketing/lead-nuturing-learn.md)
...
+ Filtraggio delle attività bot delle e-mail {#filtering-email-bot-activities}
   + [Configurazione](filtering-email-bot-activities/setup.md)
...
+ Gestione di lead e dati {#lead-and-data-management}
   ...
   + [[!UICONTROL Ciclo di vita lead]](lead-and-data-management/lead-lifecycle-learn.md)
   + [Procedura dettagliata sul ciclo di vita](lead-and-data-management/lead-lifecycle-watch.md)
+ Azioni approfondite sulle vendite {#sales-insight-actions}
   + [Panoramica](sales-insight-actions/overview.md)
   + [Panoramica delle azioni approfondite sulle vendite](sales-insight-actions/sales-insight-actions-overview.md)
   + [Accesso all’istanza delle azioni Approfondimenti sulle vendite](sales-insight-actions/accessing-your-sales-insight-actions-instance.md)
