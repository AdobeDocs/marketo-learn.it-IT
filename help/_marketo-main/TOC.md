...
+ Nozioni di base {#fundamentals}
   ...
   + [Marketing contenuti](/help/fundamentals/content-marketing-learn.md)
   + [Utenti tipo acquirenti](/help/fundamentals/buyer-personas-learn.md)
   ...
   + [Best practice per la creazione di programmi di base](/help/fundamentals/best-practices-for-creating-foundational-programs.md)
   ...
   + [Auditing di un’istanza ereditata - Tutorial](https://experienceleague.adobe.com/docs/marketo-learn/auditing-an-inherited-instance/overview.html?lang=it)
+ Programmi e campagne {#programs-and-campaigns}
   ...
   + [Informazioni sull’iscrizione al programma](/help/programs/understanding-program-membership.md)
   + [Informazioni sulle campagne smart](/help/campaigns/understanding-smart-campaigns.md)
   + [Campagne smart 101](/help/campaigns/smart-campaigns-101.md)
   ...
   + Programmi e-mail {#email-programs}
      ...
      + [Creare un’e-mail](/help/programs/email-programs/create-an-email.md)
   ...
   + Mappe di coinvolgimento {#engagement-maps}
      + [Panoramica sulla mappa di coinvolgimento](/help/engagement-maps/engagement-map-overview.md)
      + [Campagne nidificate con mappa di coinvolgimento](/help/engagement-maps/engagement-map-nested-campaign.md)
      + [Rilevamento e risoluzione degli errori della mappa di coinvolgimento](/help/engagement-maps/engagement-map-error-detection-and-resolution.md)
+ E-mail marketing {#email-marketing}
   + [E-mail pianificata](/help/email-marketing/scheduled-email-learn.md)
   + [Procedura dettagliata sulle e-mail pianificate](/help/email-marketing/scheduled-email-watch.md)
   + [Newsletter personalizzata](/help/email-marketing/personalized-newsletter-learn.md)
   + [Procedura dettagliata sulla newsletter personalizzata](/help/email-marketing/personalized-newsletter-watch.md)
   + [Offerta di contenuti con accesso riservato](/help/email-marketing/gated-content-offer-learn.md)
   + [Procedura dettagliata sull’offerta di contenuti con accesso riservato](/help/email-marketing/gated-content-offer-watch.md)
   ...
   + [Moduli](/help/email-marketing/forms-learn.md)
   + [Recapitabilità delle e-mail](/help/email-marketing/email-deliverability-learn.md)
   + [Procedura dettagliata sulla recapitabilità delle e-mail](/help/email-marketing/email-deliverability-watch.md)
   + [E-mail attivata](/help/email-marketing/triggered-email-learn.md)
   + [Procedura dettagliata sulle e-mail attivate](/help/email-marketing/triggered-email-watch.md)
   ...
   + [Filtro delle attività dei bot e-mail - Configurazione](/help/filtering-email-bot-activities/setup.md)
+ Marketing cross-channel {#cross-channel-marketing}
   + [Procedura dettagliata sui moduli](/help/email-marketing/forms-watch.md)
   + [Integrazione del mobile marketing](/help/cross-channel-marketing/mobile-marketing-learn.md)
   + [Procedura dettagliata sul mobile marketing](/help/cross-channel-marketing/mobile-marketing-watch.md)
   ...
   + [Procedura dettagliata sulla personalizzazione web](/help/cross-channel-marketing/web-personalization-watch.md)
+ Dynamic Chat {#dynamic-chat}
   + [Panoramica](/help/dynamic-chat/dynamic-chat-overview.md)
   + [Tour del prodotto [2023]](/help/dynamic-chat/product-tour.md)
   + [Tour del prodotto [2022]](/help/dynamic-chat/product-tour-2022.md)
   + [Pubblicare in 15 minuti](/help/dynamic-chat/go-live-in-15-minutes.md)
   + [Configurare e installare](/help/dynamic-chat/setup.md)
   + [Integrazione di Marketo](/help/dynamic-chat/marketo-integration.md)
   + [Gestione degli utenti](/help/dynamic-chat/user-management.md)
   + [Gestione degli agenti](/help/dynamic-chat/agent-management.md)
   ...
   + [Ricerca nel Designer flusso](/help/dynamic-chat/search-in-stream-designer.md)
   + [Acquisizione degli attributi dedotti](/help/dynamic-chat/capture-inferred-attributes.md)
   + [Anteprima dialogo](/help/dynamic-chat/dialogue-preview.md)
   ...
   + [SDK per le conversazioni](/help/dynamic-chat/conversations-sdk.md)
   ...
   + [Best practice per implementare la chat live](/help/dynamic-chat/live-chat-best-practices.md)
   + [Collegare i visitatori agli agenti live](/help/dynamic-chat/connect-visitors-to-live-agents.md)
   + [Prenotazioni riunioni](/help/dynamic-chat/meeting-booking.md)
   + [Favorire conversazioni basate su GenAI](/help/dynamic-chat/gen-ai-features.md)
...
+ Azioni Sales Insight {#sales-insight-actions}
   ...
   + [Panoramica sulle azioni di Sales Insight](/help/sales-insight-actions/sales-insight-actions-overview.md)
   + [Accesso all’istanza delle azioni di Sales Insight](/help/sales-insight-actions/accessing-your-sales-insight-actions-instance.md)
   + [Configurare la registrazione dell’attività di vendita in  [!DNL Salesforce]](/help/sales-insight-actions/configure-sales-activity-logging-to-salesforce.md)
+ Gestione dei lead e dei dati {#lead-and-data-management}
   ...
   + [Procedura dettagliata sul punteggio lead/persona](/help/lead-and-data-management/lead-scoring-watch.md)
   + [Informazioni sul ciclo di vita del lead](/help/lead-and-data-management/understanding-the-lead-lifecycle.md)
   + [Centro abbonamenti](/help/lead-and-data-management/subscription-center-learn.md)
   + [Procedura dettagliata sul centro abbonamenti](/help/lead-and-data-management/subscription-center-watch.md)
...
+ Eventi {#events}
   + [Procedura dettagliata sugli eventi](/help/events/events-watch.md)
   + [Creare un programma evento](/help/events/events-learn.md)
   + [Webinar](/help/events/webinar-learn.md)
   + [Procedura dettagliata sui webinar](/help/events/webinar-watch.md)
   + [Panoramica dei webinar interattivi](/help/events/interactive-webinars-overview.md)
   + [Gestione utenti e licenze dei webinar interattivi](/help/events/interactive-webinars-user-and-license-management.md)
   + [Creazione del programma evento per webinar interattivi](/help/events/interactive-webinars-event-program-creation.md)
   + [Panoramica sul programma evento per webinar interattivi](/help/events/interactive-webinars-event-program-overview.md)
   + [Configurazione degli eventi per webinar interattivi](/help/events/interactive-webinars-event-configuration.md)
   + [Progettare un webinar interattivo efficace](/help/events/design-an-effective-interactive-webinar.md)
   + [Consegna degli eventi dei webinar interattivi](/help/events/interactive-webinars-event-delivery.md)
   + [Approfondimenti e azioni post-evento per i webinar interattivi](/help/events/interactive-webinars-post-event-insights-and-actions.md)
...
+ Integrazioni {#integrations}
   ...
   + [Guida API - Impostare il token di accesso in una variabile](/help/integrations/api-set-access-token-variable.md)
   + [Attivare una campagna smart in Marketo Engage utilizzando l’API REST e i token](/help/integrations/trigger-smart-campaign-rest-api.md)
+ Gestione dei duplicati {#manage-duplicates}
   ...
   + [Capire perché si verificano i duplicati](/help/managing-duplicates/why-duplicates-occur.md)
   + [Identificare ed evitare i record duplicati](/help/managing-duplicates/identify-prevent-duplicates.md)
   + [Determinare quando i record duplicati sono necessari](/help/managing-duplicates/determine-necessary-duplicates.md)
   + [Unire manualmente i record duplicati](/help/managing-duplicates/merge-manually.md)
   ...
   + [Automatizzare la gestione dei duplicati - Parte 1](/help/managing-duplicates/automate-integration-part-1.md)
   + [Automatizzare la gestione dei duplicati - Parte 2](/help/managing-duplicates/automate-integration-part-2.md)
   + [Semplificare la gestione dei duplicati](/help/managing-duplicates/simplify-acs.md)
   + [Scegliere la strategia migliore per la gestione dei duplicati](/help/managing-duplicates/duplicate-strategy.md)
