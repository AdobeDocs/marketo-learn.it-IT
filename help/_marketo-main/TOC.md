...
+ Dynamic Chat {#dynamic-chat}
   ...
   + Chat automatizzata {#dc-automated-chat}
   ...
   + Prenotazione di chat e riunioni in tempo reale {#dc-live-chat-meeting-booking}
   ...
   + Chat di IA generativa {#dc-generative-ai-chat}
