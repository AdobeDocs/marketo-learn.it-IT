...
#### Inviare un messaggio e-mail agli amministratori di sistema {#send-an-email-to-system-admin}
...
#### Inviare un messaggio e-mail agli utenti del Marketo Engage {#send-an-email-to-marketo-engage-users}
