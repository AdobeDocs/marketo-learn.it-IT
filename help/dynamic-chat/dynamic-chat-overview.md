...
Benvenuto nel sito delle esercitazioni di [!UICONTROL Dynamic Chat]. Segui questi tutorial insieme alla documentazione per comprendere meglio come utilizzare [!UICONTROL Dynamic Chat] per creare conversazioni personalizzate. I seguenti argomenti possono essere utili per iniziare:
...
* Panoramica
   ...
   * **[Pubblica tra 15 minuti](go-live-in-15-minutes.md)**
     *Guida dettagliata alla pubblicazione della prima finestra di dialogo con [!UICONTROL Dynamic Chat] in soli 15 minuti!*
* Configurazione
...
* Chat automatizzata
   ...
   * **[Acquisizione degli attributi dedotti](capture-inferred-attributes.md)**
     *È possibile identificare e popolare gli attributi dedotti rispetto a ogni lead acquisito tramite Dynamic Chat sfruttando l&#39;ID Munchkin.*
   ...
   * **[Conversazioni SDK](conversations-sdk.md)**
     *Scopri come implementare Conversations SDK per convertire qualsiasi clic di CTA in una conversazione coinvolgente.*
   ...
   * **[Pagine di destinazione conversazionali](conversational-landing-pages.md)**
     *Con pochi clic, installa i flussi conversazionali di Dynamic Chat in qualsiasi pagina di destinazione (pagine di destinazione di Marketo o personalizzate) e converti qualsiasi collegamento o pulsante per attivare un coinvolgimento conversazionale.*
...
* Chat di IA generativa
   * **[Conversazioni basate su GenAI](gen-ai-features.md)**
     *Scopri come utilizzare le funzionalità di Dynamic Chat GenAI.*
* Analisi
